    ...
    */
    (function() {
        ...
        function r(b, j, a) {
            ...
            this.$controlbarUpper = $('<div style="padding:0 !important;margin:0 !important;width: 100% !important; height:  !important;margin-top:-1em !important;margin-bottom:1em !important;"></div>').appendTo(g);
        ...
        r.prototype.initializeCanvas = function(b) {
            ...
            "ratio" === b.height ? c.css("height", "300px") : "ratio" === b.width && c.css("width",
            ...
            this.events.subscribe("jSignature.attachingEventHandlers", function() {
                if (this.settings[q]) {
                    ...
                    "function" !== typeof m && (m = function() {
                        var e = $('<input type="button" value="Volver a Firmar" style="position:absolute;display:none;margin:0 !important;top:auto" />').appendTo(this.$controlbarLower),
                            k = e.width();
